...
#get ch msg
@chmsg.route('/channels/<int:channel_id>/msg')
@login_required
...
#send ch msg
@chmsg.route('/channels/<int:channel_id>/msg', methods=['POST'])
@login_required
...
#edit ch msg
@chmsg.route('/channels/<int:channel_id>/msg/<int:message_id>', methods=["PUT"])
@login_required
...
@chmsg.route('/channels/<int:channel_id>/msg/<int:message_id>', methods=["DELETE"])
@login_required
